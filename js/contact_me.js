$(function () {
    ...
    $("#mc-embedded-subscribe-form input,#mc-embedded-subscribe-form textarea").jqBootstrapValidation({
        ...
        submitSuccess: function ($form, event) {
            ...
            $.ajax({
                url: "https://softwarepioniere-functions.azurewebsites.net/api/NewsletterAnmeldung", method: "POST", dataType: "json", data: { "code": "wybtF1irV0OagSTOC2Fe8H4vWgl6Wkf678If5nUiPfALEQdViJlnMg==", "email": email}, cache: false,
                success: function () { 
