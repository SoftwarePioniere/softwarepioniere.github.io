$(function () {
    ...
    $("#mc-embedded-subscribe-form input,#mc-embedded-subscribe-form textarea").jqBootstrapValidation({
        ...
        submitSuccess: function ($form, event) {
            ...
            $.ajax({
                url: "https://softwarepioniere-functions.azurewebsites.net/api/NewsletterAnmeldung?code=wybtF1irV0OagSTOC2Fe8H4vWgl6Wkf678If5nUiPfALEQdViJlnMg==", method: "POST", dataType: "json", data: {"email": email}, cache: false,
                success: function () { 
